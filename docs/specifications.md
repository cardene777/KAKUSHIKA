...
今回**ERC6381**や**ERC6150**、**Polybase**をなぜ使用しているかについて説明していきます。  
...
### ガス代
- **ERC6150**を使用すると各記事がNFTになるため、記事投稿時にガス代がかかります。
...
これにより、いいねを押す感覚で絵文字を付与できてしまうので、何かしら対策を考えるべきか、絵文字が増えることは執筆者にとってプラスなので放置で問題ないか検討中です。
